...
async def instagram_download(message:Message):
    ...
    if result[0]=="video":
        await message.answer_video(video=result[1],caption="Admin: @Shoyiqulov_Asilbek")
    elif result[0]=="rasm":
        await message.answer_photo(photo=result[1], caption="Admin: @Shoyiqulov_Asilbek")
    else:
...
async def youtube_download(message:Message):
    ...
    await message.answer_video(video=video, caption="ADMIN: @Shoyiqulov_Asilbek")
